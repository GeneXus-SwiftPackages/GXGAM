...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "c9fd9ddde6b702c991a302db5fbf888d5c6a31d1860576a15724abc0407843f1"
		)
	]
)