...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230711133237.xcframework.zip",
			checksum: "8c6b78825dad69ec138c538a4fb273c152b142383f996093966ff3dc776cd625"
		)
	]
)