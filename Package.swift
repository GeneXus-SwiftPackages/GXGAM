...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "9a5cffc4a7c01c4ffe838ccc957c39a69de827c4adc4713acfe83d188165e1bc"
		)
	]
)