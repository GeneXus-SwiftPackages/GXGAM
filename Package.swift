...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "0ffbb118ea8cd7810937dec9d0be2a4a4e114074e55aefdc4d87528e09bcb4b0"
		)
	]
)