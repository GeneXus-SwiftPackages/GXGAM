...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230707201252.xcframework.zip",
			checksum: "0b59a8839d2284d706a6c916865999b068fa5efe9a300f2d28f3ecf6a5e2fc7f"
		)
	]
)