...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAM",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAM-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "1d6d157c11004bae470ea8200d4cf47bdf0e4379fad1c9b5a84b8d69dceec0b1"
		)
	]
)